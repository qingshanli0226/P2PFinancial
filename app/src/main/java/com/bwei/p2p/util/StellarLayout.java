...
import com.bwei.common.AnimationUtil;

public class StellarLayout  extends FrameLayout implements AnimationListener, OnTouchListener, OnGestureListener {
    ...
    public StellarLayout(@NonNull Context context) {
        this(context,null);
    }

    public StellarLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public StellarLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
