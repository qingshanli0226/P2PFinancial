package com.example.administrator.p2pdemotext.View;
...
public class RecyHomeView extends View {
    //TODO 设置圆环颜色
    ...
    public RecyHomeView(Context context) {
        super(context);
    }

    public RecyHomeView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        //TODO 渐变色
        ...
        textSize = (int) typedArray.getDimension(R.styleable.RoundProgress_textSize,10);
    ...
    public RecyHomeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        paint.setColor(Color.GRAY);
        ...
        int y = width/2 -rect.height()/2+25;
